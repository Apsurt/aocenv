...
def test_submit_correct_no_autobump(
    mock_get_session_cookies, # Added
    ...
    mock_get_session_cookies.return_value = {"session": "mock_session_id"} # Added

    mock_config = configparser.ConfigParser()
    mock_config["settings"] = {"auto_bump_on_correct": "False"}
    mock_config["variables"] = {
        "session_cookies": "mock_session_id", # This is not strictly necessary anymore but good to have
        "default_year": "2025",
        "default_day": "1",
        "default_part": "1",
    }
...
def test_submit_correct_autobump_part1_to_part2(
    ...
    mock_config = configparser.ConfigParser()
    mock_config["settings"] = {"auto_bump_on_correct": "True"}
    mock_config["variables"] = {
